{{-- Extends layout --}}
			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					<div class="card-title">
						<h3 class="card-label">Register Safeer Truck Driver</h3>
					</div>
				</div>
				...
				<form method="post" action="{{action('UserController@add_user')}}" >
				    ...
				    <div class="card-body pt-3 pb-3">
				    	...
				    	<div class="col-md-8">
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" value="{{$trucker->first_name}}" class="form-control form-control-solid form-control-lg @error('first_name') is-invalid @enderror" name="first_name" id="first_name">
									@error('first_name')
						...
						<div class="col-md-8">
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" class="form-control form-control-solid form-control-lg @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="" value="{{ str_replace('-', '', $trucker->contact) }}" >
									@error('phone')
									<div class="v-plugins-message-container text-danger mt-2">{{ $message }}</div>
									@enderror
								</div>
						...
						<div class="col-md-8">
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" class="form-control form-control-solid form-control-lg @error('cnic') is-invalid @enderror" name="cnic" id="cnic" placeholder="" value="{{ str_replace('-', '', $trucker->cnic) }}" >
									@error('cnic')
										<div class="v-plugins-message-container text-danger mt-2">{{ $message }}</div>
									@enderror
					...
					<div class="card-footer">
						...
						<button type="reset" class="btn btn-secondary"><a href="{{URL::to('trucker-profile')}}">Cancel</a></button>
					</div>
	...
	@section('scripts')
		...
		<script type="text/javascript">
			$(function(){
				$('#birth_city, #location_to_place').select2({
					multiple: false,
				});
			});
		</script>
