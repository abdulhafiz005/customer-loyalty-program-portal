			...
			<div class="card card-custom gutter-b">
				...
				<div class="card-header">
					<div class="card-title">
						<h3 class="card-label">Register System User</h3>
					</div>
				</div>
				...
				<form method="post" action="{{action('UserController@add_user')}}" >
				    ...
				    <div class="card-body pt-3 pb-3">
				    	...
				    	<div class="col-md-8">
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" class="form-control form-control-solid form-control-lg @error('first_name') is-invalid @enderror" name="first_name" id="first_name"
										placeholder="Alaska" value="{{  old('first_name') }}" >
									@error('first_name')
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" class="form-control form-control-solid form-control-lg @error('first_name') is-invalid @enderror" name="last_name" id="last_name"
										placeholder="Alaska" value="{{  old('last_name') }}" >
									@error('last_name')
										<div class="v-plugins-message-container text-danger mt-2">{{ $message }}</div>
									@enderror
								</div>
						...
						<div class="col-md-8">
							...
							<div class="form-group row fv-plugins-icon-container has-success">
								...
								<div class="col-md-7">
									<input type="text" class="form-control form-control-solid form-control-lg @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="" value="{{  old('phone') }}" >
									@error('phone')
									<div class="v-plugins-message-container text-danger mt-2">{{ $message }}</div>
									@enderror
								</div>
						...
						<div class="col-md-8" id="mechanicSupervisorsForUstasMechanics" style="display:none;">
							<div class="form-group row fv-plugins-icon-container has-success">
								<div class="col-md-3">
					...
					<div class="card-footer">
						...
						<button type="reset" class="btn btn-secondary"><a href="{{URL::to('dashboard')}}">Cancel</a></button>
					</div>
